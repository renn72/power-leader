...
CREATE TABLE `pb_comp_entry` (
	...
	`squat_bracket_id` integer DEFAULT 1,
	`bench_bracket_id` integer DEFAULT 1,
	`deadlift_bracket_id` integer DEFAULT 1,
...
CREATE TABLE `pb_competition` (
	...
	`wc_female` text,
	`wc_mix` text,
	`squat_brackets` text DEFAULT '1',
	`bench_press_brackets` text DEFAULT '1',
	`deadlift_brackets` text DEFAULT '1',
	`equipment` text,
	`formular` text,
	`current_state` text,
...
--> statement-breakpoint
CREATE INDEX `lift_comp_entry_id_idx` ON `pb_lift` (`comp_entry_id`);--> statement-breakpoint
