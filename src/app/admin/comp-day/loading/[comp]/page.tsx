...
const CompDayScreen = ({ params }: { params: { comp: string } }) => {
  ...
  return (
    <div
      className={cn(
        'dark relative grid h-full h-screen w-full grid-cols-2 overflow-hidden',
      )}
    >
      ...
      <div className='relative col-span-1 flex flex-col items-center w-full h-screen justify-between text-xl font-bold my-[2vh]'>
          <div className=''>
            <Image
              src='/RawWar_Logo.png'
              alt='RawWar Logo'
