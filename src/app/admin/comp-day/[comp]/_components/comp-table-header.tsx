	...
	return (
		<TableHead className='px-2 h-6 xl:h-10 '>
			<DropdownMenu>
				<DropdownMenuTrigger
					disabled
					className='z-999 cursor-pointer capitalize hover:text-primary'
				>{`${lift.slice(0, 1)} ${round}`}</DropdownMenuTrigger>
				<DropdownMenuContent>
	...
	return (
		<TableHeader className='z-99 bg-secondary'>
			<TableRow>
				...
				<TableHead className='h-6 xl:h-10  px-2 flex items-center justify-center'>WC</TableHead>
				{lift === 'squat' ? (
					<>
