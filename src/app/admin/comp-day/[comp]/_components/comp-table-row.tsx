...
const CompTableRow = ({
	...
	return (
		...
		>
			<Cell className='p-0 tracking-tightest xl:tracking-normal  py-0 xl:px-2 truncate w-[155px] lg:w-[255px] capitalize h-8'>
				{lifterName}
			</Cell>
			<Cell className='p-0  h-8  py-0 lg:px-4 '>
			...
			{lift === 'squat' ? (
				<>
					...
					<Lift
						...
						title='Squat 3'
						previousLift={lifterSquatTwoLift?.weight === '' ? lifterSquatOneLift : lifterSquatTwoLift}
					...
					<Lift
						...
						title='Squat 4'
						previousLift={lifterSquatThreeLift?.weight === '' ? lifterSquatOneLift : lifterSquatThreeLift}
			...
			{lift === 'bench' ? (
				<>
					...
					<Lift
						...
						title='Bench 3'
						previousLift={lifterBenchTwoLift?.weight === '' ? lifterBenchOneLift : lifterBenchTwoLift}
					...
					<Lift
						...
						title='Bench 4'
						previousLift={lifterBenchThreeLift?.weight === '' ? lifterBenchOneLift : lifterBenchThreeLift}
			...
			{lift === 'deadlift' ? (
				<>
					...
					<Lift
						...
						title='Deadlift 3'
						previousLift={lifterDeadliftTwoLift?.weight === '' ? lifterDeadliftOneLift : lifterDeadliftTwoLift}
					...
					<Lift
						...
						title='Deadlift 4'
						previousLift={lifterDeadliftThreeLift?.weight === '' ? lifterDeadliftOneLift : lifterDeadliftThreeLift}
			...
			<Cell className='p-0 xl:p-2 h-8'>
				{+index === i ? (
					<Button
						variant='ghost'
						className='cursor-auto text-complete hover:bg-muted/10 hover:text-complete h-8'
					>
						<UserCheck
							size={20}
							strokeWidth={3}
					...
					<Button
						variant='ghost'
						className='hover:text-muted-foreground h-8'
						onClick={() => {
							setIndex(i.toString())
							updateLift({
								id: competition.id,
