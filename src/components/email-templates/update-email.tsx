...
export const ShowdownEmail = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>{username}, please confirm your details for Saturday's event</Preview>
      <Body style={main}>
        <Container style={container}>
          <Section style={section}>
            <Text style={text}>Hi {username},</Text>
            <Text style={text}>
              Just a quick reminder that you're scheduled to participate in Showdown V this Saturday (22nd).
            </Text>
            <Text style={text}>
              Could you please take a moment to verify your lift openers, and personal bests? This will
              help us ensure everything runs smoothly on the day.
            <Text style={smtext}>
            ...
            <Text style={actionText}>
              <Link style={textLink} href={`https://www.showdown.warner.systems/user${updateLink}`}>
          ...
          <Section style={section}>
            ...
            <Text style={linkText}>
              ...
              <Link style={textLink} href={flightInfoLink}>
                View flight schedule
              </Link>
            </Text>
            <Text style={linkText}>
              • Track results in real-time:{" "}
              <Link style={textLink} href={leaderboardLink}>
