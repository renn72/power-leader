...
export const compEntry = createTable(
  'comp_entry',
  {
    ...
    squatBracket: int('squat_bracket_id').default(1),
    benchBracket: int('bench_bracket_id').default(1),
    deadliftBracket: int('deadlift_bracket_id').default(1),
...
export const competitions = createTable('competition', {
  ...
  wc_mix: text('wc_mix'),
  squatBrackets: text('squat_brackets').default('1'),
  benchPressBrackets: text('bench_press_brackets').default('1'),
  deadliftBrackets: text('deadlift_brackets').default('1'),
  equipment: text('equipment'),
...
export const compDayInfo = createTable(
  'comp_day_info',
  {
    ...
    screen2Size: text('screen2_size'),
    screen3: text('screen3'),
    screen3Size: text('screen3_size'),
    screen4: text('screen4'),
    screen4Size: text('screen4_size'),
    screen5: text('screen5'),
    screen5Size: text('screen5_size'),
    screen6: text('screen6'),
    screen6Size: text('screen6_size'),
    screen7: text('screen7'),
    screen7Size: text('screen7_size'),
    screen8: text('screen8'),
    screen8Size: text('screen8_size'),
    screen9: text('screen9'),
    screen9Size: text('screen9_size'),
    screen10: text('screen10'),
    screen10Size: text('screen10_size'),
    screen11: text('screen11'),
    screen11Size: text('screen11_size'),
    screen12: text('screen12'),
    screen12Size: text('screen12_size'),
  },
  (t) => {
    return {
