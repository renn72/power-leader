...
export const compEntry = createTable('comp_entry', {
    ...
    squatOrderOne: int('squat_order_id'),
    squatOrderTwo: int('squat_order_id'),
    squatOrderThree: int('squat_order_id'),
    squatOrderFour: int('squat_order_id'),
    isSquatFour: int('is_squat_four', { mode: 'boolean' }),
    benchOrderOne: int('bench_order_id'),
    benchOrderTwo: int('bench_order_id'),
    benchOrderThree: int('bench_order_id'),
    benchOrderFour: int('bench_order_id'),
    isBenchFour: int('is_bench_four', { mode: 'boolean' }),
    deadliftOrderOne: int('deadlift_order_id'),
    deadliftOrderTwo: int('deadlift_order_id'),
    deadliftOrderThree: int('deadlift_order_id'),
    deadliftOrderFour: int('deadlift_order_id'),
